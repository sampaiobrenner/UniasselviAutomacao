...
void setup()
{
  ...
  Serial.println("Informe um valor entre 0 e 5 Volts");
...
void loop()
{
  ...
  if (Serial.available())
  {
    ...
    float tensao = Serial.parseFloat();
    
    // Verifica se o valor lido está entre 0 e 5 volts
    // https://www.arduino.cc/en/Reference/If
    if (tensao >= 0 and tensao <= 5)
    {
      ...
      int brilho = (int)(tensao * 255) / 5;
      
      Serial.print("Tensao = ");
      Serial.print(tensao, 2); // Exibe o valor com 2 casas decimais
      Serial.println("V");
      Serial.print("Brilho = ");
    ...
    {
      Serial.println("O valor informado deve estar entre 0 e 5...");
    }
  }
}
